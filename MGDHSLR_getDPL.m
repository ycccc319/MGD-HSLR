function [probYt,trustable,predLabels] = MGDHSLR_getDPL(Zs,Ys,Zt,lastPredLabels,pos,selectRate)
%% input
...
if ~isempty(lastPredLabels)
    if size(lastPredLabels,1)>0
        lastPredLabels = lastPredLabels';
    end
